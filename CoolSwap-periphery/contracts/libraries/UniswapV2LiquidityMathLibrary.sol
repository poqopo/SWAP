...
library UniswapV2LiquidityMathLibrary {
    ...
    function getReservesAfterArbitrage(
        ...
        if (aToB) {
            uint amountOut = SwapLibrary.getAmountOut(amountIn, reserveA, reserveB);
            reserveA += amountIn;
            reserveB -= amountOut;
        } else {
            uint amountOut = SwapLibrary.getAmountOut(amountIn, reserveB, reserveA);
            reserveB += amountIn;
            reserveA -= amountOut;
        }
    }
    ...
    function getLiquidityValue(
        ...
        IUniswapV2Pair pair = IUniswapV2Pair(SwapLibrary.pairFor(factory, tokenA, tokenB));
